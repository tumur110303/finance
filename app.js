...
var uiController = (function () {
  ...
  return {
    ...
    displayPercentages: function (allPercentages) {
      //Зарлагын NodeList-ийг олох. Node --> гэдэг нь DOM-ын нэг элемент буюу нэг tag-ийг хэлдэг. Ж нь: <button>click me</button>
    ...
    addListItem: function (item, type) {
      // Орлого, зарлагын элементийг агуулсан hmtl-ийг бэлтгэнэ.
      var html, list;
      if (type === "inc") {
...
var financeController = (function () {
  ...
  return {
    ...
    // deleteItem: Орлого, зарлагыг устгах button дарахад тухайн орлого, зарлагыг устгадаг функц.
